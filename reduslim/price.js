$(function () {
   ...
   selects.append('<option value="UA" ' + ua_selected + '>Украина</option>');
    ...
    selects.append('<option value="ES">Испания</option>');
    selects.append('<option value="IT">Италия</option>');
    ...
    var change = 0,
        updatePrices = function (item) {
            ...
            if (sel == 'IT') {
                ...
                initializeMask({mask:"(+3\\9\\)999999[99999]",removeMaskOnSubmit: true})
            }

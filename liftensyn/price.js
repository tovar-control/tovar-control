$(function () {
    ...
    var change = 0,
        updatePrices = function (item) {
            ...
            if (sel == 'RU') {
                $('.old_price_val').html('2450');
                $('.old_price_cur').html('руб');
                $('.old_price_sig').html('&#8381;');
                $('.new_price_val').html('860');
            ...
            if (sel == 'KZ') {
                $('.old_price_val').html('13570');
                $('.old_price_cur').html('тнг');
                $('.old_price_sig').html('тнг');
                $('.new_price_val').html('4790');
            ...
            if (sel == 'UA') {
                $('.old_price_val').html('1115');
                $('.old_price_cur').html('грн');
                $('.old_price_sig').html('грн');
                $('.new_price_val').html('398');
            ...
            if (sel == 'MD') {
                $('.old_price_val').html('790');
                $('.old_price_cur').html('лей');
                $('.old_price_sig').html('лей');
                $('.new_price_val').html('278');
            ...
            if (sel == 'BY') {
                $('.old_price_val').html('70');
                $('.old_price_cur').html('р');
                $('.old_price_sig').html('р');
                $('.new_price_val').html('35');
            ...
            if (sel == 'AM') {
                ...
                $('.new_price_val').html('12990');
                $('.new_price_cur').html('др');
                $('.new_price_sig').html('др');
                $('select').val(sel).trigger('change');
                initializeMask({mask:"(+374)99999999[9]",removeMaskOnSubmit: true})
            }

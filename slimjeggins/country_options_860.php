...
$(function () {
    ...
    function updatePrices(item) {
     ...
     if (sel=='RU') {
        $('.old_price_val_').html('2 190');
        $('.old_price_val').html('2190');
        $('.old_price_cur').html('руб');
        $('.old_price_sig').html('&#8381;');
        $('.new_price_val_').html('860');
        $('.new_price_val').html('860');
        $('.new_price_val_1').html('1190');
        $('.new_price_val_2').html('1590');
        $('.new_price_cur').html('руб');
        $('.new_price_sig').html('&#8381;');
        $('.discount_now').html('1330');
        $('.discount_1').html('1000');
        $('.discount_2').html('600');
